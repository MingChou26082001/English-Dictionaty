...
public class SuggestionsDatabase {
    ...
    {
        return db.query(true, TABLE_SUGGESTION, new String[] {FIELD_ID, FIELD_SUGGESTION},
                FIELD_SUGGESTION + " LIKE '" + text + "%'", null, FIELD_SUGGESTION, null, null, "20");
    ...
    private class Helper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            String drop_dictionary_table = "DROP TABLE IF EXISTS " + TABLE_SUGGESTION;
